...
Not to be confused with Java. JavaScript is not related to the Java programming language.

*Contributed by [Alison Mills](https://github.com/az-m)*
...
Using ordinary words and expressions instead of actual code, so you can jot down how you want to structure the program before you start real coding.
...
Ruby on Rails allows Ruby to be used as a back-end language for web applications.
