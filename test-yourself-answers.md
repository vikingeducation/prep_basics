...
The Web refers to the World Wide Web, a massive collection of documents, images, content, applications and data. These resources are identified via URLs (see below) and are then accessed via the Internet.
