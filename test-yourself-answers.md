...
Simply a way to write logic in plain english so that you can build the code as you go.

*Contributed by [Andrew James](https://github.com/ajames20)*
...
An enjoyable way to share coed with others, and way to work on current coed without having to edit existing code.
