...
It's like a time machine for jumping back and forth between specific time stamp for coding.  It's used to keep track of changes that are made as the project develops and allows for the programmer view previous builds that they may want to compare or restore.

*Constributed by [Christopher Wilson](http://github.com/cwils)*
