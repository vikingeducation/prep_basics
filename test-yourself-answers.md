...
The scripting language that runs on the client side of the web, in the browser. It allows interactivity with the user. It is also invading the back-end with the popularity of nodejs.
...
One of the most popular open-source version control systems for tracking changes in computer files while also sharing the changes among multiple people. 
