...
A program that utilizes HTTP to give the files that create Web pages to users based on their request.

*Contributed by [Aarohan Tuladhar](https://github.com/aarohan-t)*
