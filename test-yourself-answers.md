...
Bugs are identified through user experience or testing practices.
Bugs can arise in new functionality through errors in development or in existing functionality through changes to code or associated configuration. 
...
CSS is used to define styles, layout and presentation of one or many webpages.
