...
Front end developers focus on the client side of web applications, which includes how the website looks and to some extent how the user interacts with it.
Back end developers focus on the server side of web apps and work with programming languages such as python, php, ruby and java, to write codes implemented by servers. Full stack developers do both the front end and back end side of web application development.

#What's the difference between static and dynamic web pages?

Static pages a mostly built with HTML and css. They do not allow the user to interact with the pages. Whereas, dynamic web pages have some functionality added to it, mainly through javascript. This allows end users to interact with the pages.

#What is css and how is it used?

CSS is the acronmy for Cascading Style Sheets. Whereas, HTML is responsible for structuring the content of a web page, CSS is used to style the content of a web page.

*Contributed by [Bassie Bangura](https://github.com/bassiebangura)*