...
In order for you to contribute o someone else's project, you'll first have to copy their Github repo into your own repo. so forking is a way to allows you to make changes on your own now-separate repo without messing theirs up
...
Branching allows you to create multiple version of your repo. It can be use when working on an experimental new feature and want to keep it completely on a different track from your main code base or to collaborate with another developer and both work on separate features at once etc.

*Contributed by [Thinh Nguyen](https://github.com/timtnguyen)*
