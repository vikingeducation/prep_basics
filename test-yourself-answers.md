...
#### How do you check, if your local repo is connected to a remote server (f.e. Github)?

$ git remote -v

*Contributed by [Carsten Rapp](https://github.com/crapp80)*

#### How do you add a local repo to GitHub?

$ git remote add origin "Enter the remote repository url"
