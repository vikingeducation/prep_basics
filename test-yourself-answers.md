...
A computer that answers HTTP requests.
*Contributed by [Eric Pace](http://github.com/greenep)*
...
Version Control, also know as revision control, is the method of systematically tracking changes so you can restore a specific version of the saved file(s) later on.
...
Software that includes access to it's source code to allow anyone to add, change, modify, or delete parts of it to serve their purpose.
