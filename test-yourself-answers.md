...
### The Web
Space where documents and many other web resources are accessed by using URLs linked to each other and accessed through the internet.
*Contributed by [Bradon Fredrickson](https://github.com/bradonf333)*
