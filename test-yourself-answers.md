...
Some editors, like Atom, also have direct integration with Git.
...
### The Web
The web is an information system on the Internet that allows documents to be connected to other documents by hypertext links, enabling the user to search for information by moving from one document to another.
