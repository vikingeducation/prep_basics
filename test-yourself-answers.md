...
Information is broken down into individual packets that are addressed to the same location and include instructions for reassembly. They are then routed via different paths and upon arrival reassembled by the receiver.
