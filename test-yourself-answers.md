...
One of the most popular open-source version control systems. Enabling easy way to collaborate on the same projects/files.

*Contributed by [Enar Mariinsky](https://github.com/Mariinsky)*
...
You can create a new branch with command: git branch your_branch_name

*Contributed by [Enar Mariinsky](http://github.com/Mariinsky)*
