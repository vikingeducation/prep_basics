...
## How the Web Works
The data transfered to your browser is broken up into "packets" that are sent to the receiver and are reassembled on thier machine displaying the data that was sent.

*Contributed by [Trevor Hoffart] (https://github.com/RaccoonWarrior)*
