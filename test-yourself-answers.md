...
`$ cd <directoryName>`
*Contributed by [Jon-Marques](https://github.com/Jon-Marques)*
...
`$ man <cmd>`
*Contributed by [Jon-Marques Psalms](https://github.com/Jon-Marques)*
...
"Tells the browser what all the pieces of the browser page should look like. CSS descibes the presentation including fonts, colors, and layouts"
*Contributed by [Ashton Christie](https://github.com/ashchristie)*
*Contributed by [Jon-Marques Psalms](https://github.com/Jon-Marques)
