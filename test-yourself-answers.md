...
Information starts as one huge packet, which is broken down into smaller packets. These small packets are then send through different paths to reach a common destination, where they all are assembled to form a packet resembling the one that was sent initially.

*Contributed by [Aman Ahuja](http://github.com/trcxr)*
