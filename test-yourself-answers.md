...
Front end developers focus on the design and functionality of the website and how it interacts with its users. Back end developers focus on the server functionality and how it communicates with the website. Full stack developers can do both.

### What does forking a repository mean?

Forking a repository means copying someone else's repository to your github account. This allows you to contribute to other people's projects independently without making changes to their master file.

### What does cloning a repository mean?

Cloning a repository means downloading a repository from your github account onto your hard drive. This allows you to make updates without changing the repository in github. You can either clone a repository you own, someone else's repository, or a repository you forked.

*Contributed by [Jorge Luis Leon](http://github.com/jluis0803)*
