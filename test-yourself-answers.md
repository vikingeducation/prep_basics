...
#### What is RVM and how will it be useful later?
RVM is Ruby Version Manager. It allows you to run multiple versions of Ruby on one system. For example, you could use Ruby 2.3 with one Rails project and Ruby 2.2 with a
Sinatra project.

#### HTTP
Hyper Text Transfer Protocol
It's a text-based "agreement" for how to transfer data across the WWW.

#### What are the closet developer communities to you?
