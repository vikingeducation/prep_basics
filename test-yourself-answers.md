...
For example: Google Drive and Dropbox are a network of remote servers that can be used to store personal files such as pictures, music and videos.

*Contributed by [Aaron Dressler](http://github.com/aarondressler)*
*Contributed by [Kevin Phillips])(http://github.com/kphillipsjr1101)*
