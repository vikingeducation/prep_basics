...
POP stores emails locally on a computer - not a mail server. Mail can only be accessed from one computer.
IMAP stores emails on a server. Emails can be accessed by multiple devices.
