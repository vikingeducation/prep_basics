...
The scripting language that runs in the browser. It allows interactivity with the user. It is also invading the back-end with the popularity of nodejs and the front-end with jQuery.
...
From the master, create a new branch by typing:
