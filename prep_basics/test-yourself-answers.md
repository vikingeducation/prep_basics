...
Packets! I see packets kind of like Majin Buu!(Dragon Ball z reference) Majin buu was a villain who get blown to smithereens, turn into little blobs, and no matter where they were they would come back to be whole again. The packets are those "blobs." or snippets of information. This reference more directly relates to when the server "serves you back up" the website. The website is too large to send as a whole(majin buu is severely obese coincidentally) back to your computer unfortunately :( . But it gets sent in really small "blobs" or packets, and they regenerate/complile themselves on your computer ! 

#### What's the best way to get help when you get stuck?

I'd have to say personally , GOOGLE! Every developer I ask says that.

#### What are alias commands?

Um..... the best thing ever. I remember reading the article in the prep work of WHAT makes a good developer. One of those traits were LAZINESS. If you want to be lazy typing things or dont wan't to really remember some commands this is the way to go. It's when you can make long commands such as:

git commit -m"Initial Commit"

whew.. that is alot to type. Let's make it shorter:

alias ci="git commit -m"

Now I can type in my terminal:

ci"initial commit"

for when initially commit! Woo hoo, laziness here I come.



*Contributed by [Tayari Appiah](http://github.com/cjhhh)*